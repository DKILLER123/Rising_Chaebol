...
**MC:** Song Ji-yeon
**Edition:** Version 3 English edition, 113 chapters
...
- The current package is the latest 113-chapter build documented at the end of `worklog.md`.
- `epub/OEBPS/text/copyright.xhtml` still contains a historical “one-hundred-nine chapter”
  description while the package metadata and title page identify 113 chapters. This is an existing
  editorial follow-up, not a setup mutation; correct it in a future authorized content pass and
  then re-run every count and package gate.
...
- The full mark audit and style audit are also preserved under `reports/`. The mark audit found
  ...
  older chapters; the style report records that the existing 113-chapter baseline is below the
  eight-distinct-block floor in many chapters. These are the next editorial QA queue, not package
  extraction failures.
